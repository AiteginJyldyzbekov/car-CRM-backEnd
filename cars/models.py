...
class Car(models.Model):
    ...
    image1 = models.ImageField("Фотография автомобиля с правой стороны", upload_to="cars/images", null=True,blank=True)
    image2 = models.ImageField("Фотография автомобиля с левой стороны", upload_to="cars/images", null=True,blank=True)
    image3 = models.ImageField("Фотография автомобиля с задней стороны", upload_to="cars/images", null=True,blank=True)
    image4 = models.ImageField("Фотография автомобиля с передней стороны", upload_to="cars/images", null=True,blank=True)
    ...
    passport_image = models.ImageField("Фотография Техпаспорта", upload_to="cars/passport_images", null=True,blank=True)
    ...
    last_checking = models.DateField("Последний технический осмотр", null=True, blank=True)
